...
const Hero = () => {
  return (
    <div className=" mt-20  lg:-mt-20 w-full flex justify-center lg:justify-between items-center flex-col lg:flex-row px-10 lg:px-0  gap-y-10  lg:pb-0 h-screen  bg-[#18171C] lg:bg-transparent">
